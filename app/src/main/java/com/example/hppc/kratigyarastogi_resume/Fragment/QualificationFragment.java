...
import com.example.hppc.kratigyarastogi_resume.Adapter.QualAdapter;
...
public class QualificationFragment extends Fragment {
    ...
    public static QualificationFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) rootView.findViewById(R.id.qualRecView);
        recyclerView.setHasFixedSize(true);
        recLayoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(recLayoutManager);

        recAdapter = new QualAdapter();
